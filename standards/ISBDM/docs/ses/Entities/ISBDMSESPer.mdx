...
The encoding scheme is applicable to the value of a <InLink href="/docs/relationships/1006">has person associated with manifestation</InLink> element or element sub-type.
...
<details>
  ...
  *Full example*: <InLink href="/docs/fullex/fx045">Treachery of images (ceci n'est pas
