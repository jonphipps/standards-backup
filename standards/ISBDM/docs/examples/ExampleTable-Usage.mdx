...
<ExampleTable caption="Custom table example">
  <tr>
    <td className="elementColumn">
      <a href="/docs/statements/1028.html">has manifestation statement</a>
    </td>
  ...
  <tr>
    <td className="elementColumn">
      <a href="/docs/statements/1029.html">has edition statement</a>
    </td>
    <td className="valueColumn">
      "First edition"
    </td>
...
<ExampleTable
  ...
  entries={[
    ...
    },
    {
      ...
      elementUrl: "/docs/relationships/1254.html",
